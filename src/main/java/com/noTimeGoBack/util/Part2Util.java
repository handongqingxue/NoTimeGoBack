		...
		sb.append("<div class=\"main_div\">");
			sb.append("<div class=\"chapter_div\">");
				...
				sb.append("<div class=\"content_div\">");
					...
					sb.append("</div>");
					sb.append("<div class=\"paragraph_div\">");
						sb.append("走了一个多时辰，一条大河又出现在他们眼前，原来他们又绕回到了刚才的地方。现在他们有两个选择，要么放弃继续寻找西蒙，坐着漂浮物原路回去；要么想办法继续往前走，走出这片迷林。几位猎户继续缓慢的摸索着前行，感觉一直超前行走，但花了三个多时辰，却迂回了三次都绕回了原地。太阳慢慢的从地平线升起，天快亮了，有位猎户建议先休息一会再想办法，这样继续走下去只能白白的消耗体力。");
					sb.append("</div>");
					sb.append("<div class=\"paragraph_div\">");
						sb.append("");
					sb.append("</div>");
