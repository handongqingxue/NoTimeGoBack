		...
		sb.append("<div class=\"main_div\">");
			sb.append("<div class=\"chapter_div\">");
				...
				sb.append("<div class=\"content_div\">");
					...
					sb.append("</div>");
					sb.append("<div class=\"paragraph_div\">");
						sb.append("听祖师这么一说，葛申想到了破解葫芦法术的法子，只要沾上童子尿，瞬间就直接变成了一般的葫芦，到时候妖精失去了法宝，凭咱这边的实力对付他们就不在话下了。为了拯救天下苍生，清风、白石、明月等童子自告奋勇的原随葛叔一起去讨伐黑风寨，葛申和祖师都不建议这几个孩子去，为了提供童子尿去冒险，万一失足就白白搭上了性命。可童子们坚持要去，因为他们的父母就是被这帮妖精害死的，多亏祖师收留才活到现在。为了报答祖师的恩情，非去不可。葛申和秋琴等人发誓要保护孩子们的安全，一定要让他们活着回来，否则等讨伐成功后便拔剑自刎。祖师这才勉强同意童子们随大人们下山。");
					sb.append("</div>");
					sb.append("<div class=\"paragraph_div\">");
						sb.append("下山前，大伙和祖师、童子们一起围桌而坐。大家商量好对策，等晚上戌时去山寨救人。葛申、秋琴、小七、小五、小二、童子等人一队，穿上猎户从盔甲兵身上取来的盔甲装扮好进寨，找准机会放火放信号。猎户们一队，在院外的大树上留意夜空中的信号，看到硝酸铝(3)信号说明没被妖精发现，就大胆的从大理石门闯进来营救人质。若发现硫酸铜(4)信号，说明被发现了，就穿上盔甲兵的盔甲混进来接应他们离开山寨，到时候回祖师那里再想其他对策营救。");
					sb.append("</div>");
					sb.append("<div class=\"paragraph_div\">");
