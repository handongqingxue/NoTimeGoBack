...
public class Part2Util {
	 ...
	 * 第12章标题
	 */
	public static final String CHAP12_TIT_NAME="第12章 大闹黑风寨";
		...
		sb.append("<div class=\"main_div\">");
			sb.append("<div class=\"chapter_div\">");
				...
				sb.append("<div class=\"content_div\">");
					...
					sb.append("</div>");
					sb.append("<div class=\"paragraph_div\">");
						sb.append("正当大家替西蒙担心时，草丛里有骚动声，猎户们给枪上好子弹准备作战。但出来的不是敌人，而是一只狐狸，嘴里叼着一只死了的猫女的尸体往前跑。狐狸是狡猾的，猎户们觉得跟着狐狸走说不定能发现什么线索。狐狸虽然跑的快，但猎户们的奔跑速度还是追赶的上。跑了一段路，感觉树林的景象不再是周而复始的，而是有座城堡出现在面前。城堡旁边有个洞，狐狸进洞去了。多亏了这只狐狸，不然猎户还真的找不到这里。虽然看到了城堡，但还是没找到西蒙，连个人影和脚印都没看到。说到脚印，猎户们突然间看到地上有一个大脚印，比西蒙的大很多，踩在地上留下了很深的坑。除了大脚印外，旁边还有几个小些的脚印。通过对比，猎户们可以确定这小脚印就是西蒙留下的。能看到脚印却没看到人，西蒙一定是出事了。大脚印像是巨人的，西蒙身上带着伤，只穿着一条白裤衩。要是遇到这么大的巨人肯定对付不了，况且就算他没受伤，遇到这么大的巨人也不一定能应付的了。");
					sb.append("</div>");
					sb.append("<div class=\"paragraph_div\">");
						sb.append("说起裤衩，猎户们顺着脚印方向寻找，看到它到草丛处就不见了，而草丛顶上挂着一件白色东西。猎户走进一看，正是西蒙的白裤衩。裤衩上除了沾着两股已干的黄色液体外，还藏着一张白纸。猎户打开纸一看，上面写着两行字，第一行：“白杨树处往左拐”、第二行：“法宝口令‘如意如意、按我心意、快快显灵。’”。除了这张纸和这条裤衩外，猎户还在草丛里找到了西蒙的长鞭和回旋镖，长鞭已经断成了两节，回旋镖的刀刃上也有一道道牙印缺口。糟了，西蒙百分之百出事了，裤衩没了，他肯定是和昨晚走进楼道一样，光着身子。猎户们不管是否能引来敌人，大喊：“西蒙！西蒙！”除了树上的几只鸟飞走外，再别无其他动静。");
					sb.append("</div>");
					sb.append("<div class=\"paragraph_div\">");
						sb.append("");
					sb.append("</div>");
